...
> **Important:** The default observations are 17 real historical Argo profiles from 12 February 2026. The bundled ocean model remains synthetic. This is not live INCOIS data, an operational forecast, or independent validation of model skill. See [source and upload instructions](docs/REAL_ARGO.md).
...
- Real historical Argo profiles with source, WMO/cycle, timestamps and QC provenance; optional synthetic Argo/glider demonstration.
...
| Default observations | 17 measured Argo profiles; 11,485 depth rows |
| Optional synthetic catalogue | 17 synthetic Argo profiles and 5 synthetic glider profiles |
